<template>
  <aside>
    <el-header><span class="page-title">bonote</span></el-header>
    <Avatars/>
    ...
    <el-menu default-active="2" :default-openeds="['2']" background-color="#161B22">
      ...
      <el-menu-item index="5">
        <a href="https://github.com/gaojuze/bonote" class="web-intro" target="_blank">
...
store.getNotebookList().then(() => {
  if (store.notebookList.length === 0) {
    store.initialize().then(() => {
      store.addNote({title: '欢迎使用bonote', content: ''})
